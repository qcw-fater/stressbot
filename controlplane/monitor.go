...
func ToProtoCollectorSnapshot(src *monitor.CollectorSnapshot) *controlpb.CollectorSnapshot {
	if src == nil {
		return nil
	}
	out := &controlpb.CollectorSnapshot{
...
func FromProtoCollectorSnapshot(src *controlpb.CollectorSnapshot) *monitor.CollectorSnapshot {
	if src == nil {
		return nil
	}
...
func toProtoHistogram(src monitor.HistogramSnapshot) *controlpb.HistogramSnapshot {
	return &controlpb.HistogramSnapshot{
		Count:         src.Count,
...
func fromProtoHistogram(src *controlpb.HistogramSnapshot) monitor.HistogramSnapshot {
	if src == nil {
...
func toProtoActions(src []monitor.ActionSnapshot) []*controlpb.ActionSnapshot {
	if src == nil {
		return nil
	}
	out := make([]*controlpb.ActionSnapshot, len(src))
	for i := range src {
...
func fromProtoActions(src []*controlpb.ActionSnapshot) []monitor.ActionSnapshot {
	if src == nil {
		return nil
	}
...
func toProtoAction(src monitor.ActionSnapshot) *controlpb.ActionSnapshot {
	out := &controlpb.ActionSnapshot{
		Name:                              src.Name,
	...
	if src.Errors != nil {
		out.Errors = make([]*controlpb.ErrorEntry, len(src.Errors))
		for i := range src.Errors {
			errEntry := src.Errors[i]
			out.Errors[i] = &controlpb.ErrorEntry{
				Code:     errEntry.Code,
...
func fromProtoAction(src *controlpb.ActionSnapshot) monitor.ActionSnapshot {
	if src == nil {
...
func toProtoSummary(src monitor.SnapshotSummary) *controlpb.SnapshotSummary {
	return &controlpb.SnapshotSummary{
		SampleCount:                       src.SampleCount,
		SuccessCount:                      src.SuccessCount,
		FailureCount:                      src.FailureCount,
		TimeoutCount:                      src.TimeoutCount,
...
func fromProtoSummary(src *controlpb.SnapshotSummary) monitor.SnapshotSummary {
	if src == nil {
...
func toProtoWindow(src *monitor.ReportWindow) *controlpb.ReportWindow {
	if src == nil {
		return nil
	}
	return &controlpb.ReportWindow{
		...
		Summary:                 toProtoSummary(src.Summary),
		Bandwidth: &controlpb.WindowBandwidthSnapshot{
...
func fromProtoWindow(src *controlpb.ReportWindow) *monitor.ReportWindow {
	if src == nil {
		return nil
	}
...
func toProtoMonitorSystem(src monitor.SystemSnapshot) *controlpb.MonitorSystemSnapshot {
	return &controlpb.MonitorSystemSnapshot{
...
func fromProtoMonitorSystem(src *controlpb.MonitorSystemSnapshot) monitor.SystemSnapshot {
	if src == nil {
...
func toProtoRobots(src monitor.RobotSnapshot) *controlpb.RobotSnapshot {
	return &controlpb.RobotSnapshot{Started: src.Started, Running: src.Running, Stopped: src.Stopped, Errored: src.Errored}
}

func fromProtoRobots(src *controlpb.RobotSnapshot) monitor.RobotSnapshot {
	if src == nil {
...
func toProtoRampUp(src monitor.RampUpSnapshot) *controlpb.RampUpSnapshot {
	return &controlpb.RampUpSnapshot{CurrentStage: int32(src.CurrentStage), TotalStages: int32(src.TotalStages)}
}

func fromProtoRampUp(src *controlpb.RampUpSnapshot) monitor.RampUpSnapshot {
	if src == nil {
...
func toProtoConnections(src monitor.ConnectionSnapshot) *controlpb.ConnectionSnapshot {
	return &controlpb.ConnectionSnapshot{
...
func fromProtoConnections(src *controlpb.ConnectionSnapshot) monitor.ConnectionSnapshot {
	if src == nil {
...
func toProtoBandwidth(src monitor.BandwidthSnapshot) *controlpb.BandwidthSnapshot {
	return &controlpb.BandwidthSnapshot{
		TotalSendBytes:            src.TotalSendBytes,
		TotalReceiveBytes:         src.TotalRecvBytes,
...
func fromProtoBandwidth(src *controlpb.BandwidthSnapshot) monitor.BandwidthSnapshot {
	if src == nil {
