  ...
  functions: [
    {
      ...
      returns: 'code : number',
      summary: '建立 TCP 连接',
      detail: 'code: 0=成功 / 非零=错误码（6=取消，2=连接关闭）。',
    },
    {
      name: 'connect_udp',
      module: 'network',
    ...
    },
    {
      ...
      detail: 'code: 0=成功 / 31=超时 / 6=取消 / 12=解析失败 / 其他非零=服务端 HeaderErr。需先调用 ensure_udp_listener() 注册监听占位。',
    },
    {
      name: 'http_request',
      module: 'network',
      ...
      summary: 'HTTP 请求',
      detail: '1-99=框架传输错误（errcode）/ 其他=HTTP 原始状态码（200/404/500 等）。',
    },
    {
      name: 'tcp_listen',
      module: 'network',
